...
// Assembly baslangic kodunu yazdir.
void cgpreamble()
{
    freeall_registers();
    fputs( // Cikti dosyasina assembly kodunu yazdir.
        // Veri bolumu: String sabitleri buraya gelir.
        "\t.text\n"         // Kod bolumunun baslangici.
        "\t.section\t__TEXT,__cstring,cstring_literals\n" // MacOS/ARM64'te stringler icin bolum.
        ".L.str:\n"         // printf icin format string etiketi.
        "\t.asciz\t\"%d\\n\"\n" // "%d\n" string sabiti.

        // Kod bolumu: Fonksiyonlar buraya gelir.
        "\t.section\t__TEXT,__text,regular,pure_instructions\n"
        "\t.globl\t_printint\n" // printint fonksiyonunu global olarak gorunur yap (MacOS'ta C fonksiyonlari _ ile baslar).
        "\t.p2align 2\n"    // 4 bayt (2^2) hizalama.
        "_printint:\n"
        ...
        // printf gibi variadic fonksiyonlar icin yiginda ek alan ayir.
        "\tsub\tsp, sp, #16\n"

        // Yazdirilacak deger bize x0'da geliyor. Onu yigina koymaliyiz.
        "\tstr\tx0, [sp]\n"

        // Simdi format string'inin adresini x0'a yukleyebiliriz.
        "\tadrp\tx0, .L.str@GOTPAGE\n"
        "\tldr\tx0, [x0, .L.str@GOTPAGEOFF]\n"

        // printf'i cagir. x0'da format string var, diger arguman yiginda.
        "\tbl\t_printf\n"

        // Standart fonksiyon bitisi (epilogue)
        // mov sp, x29 komutu, sub sp, sp, #16 dahil tum yigin islemlerini geri alir.
        "\tmov\tsp, x29\n"
        "\tldp\tx29, x30, [sp], #16\n"
        "\tret\n"

        "\n"
        "\t.globl\t_main\n" // _main fonksiyonunu global olarak gorunur yap.
        "\t.p2align 2\n"    // 4 bayt hizalama.
        "_main:\n"
        // _main fonksiyonu baslangici.
        "\tstp\tx29, x30, [sp, #-16]!\n" // x29, x30'u yigina kaydet.
        "\tmov\tx29, sp\n" // x29'u sp'ye ayarla.
        "\tsub\tsp, sp, #16\n",
    Outfile);
}

// Assembly bitis kodunu yazdir.
void cgpostamble()
{
    fputs( // Cikti dosyasina assembly kodunu yazdir.
        "\tmov\tx0, #0\n" // Programin cikis durumunu 0 olarak ayarla (x0: donus degeri kayitcisi).
        "\tmov\tsp, x29\n"
        // _main fonksiyonu bitisi.
        "\tldp\tx29, x30, [sp], #16\n" // x29, x30'u yigindan geri yukle.
        "\tret\n", // Fonksiyondan don (main fonksiyonunu sonlandirir).
    Outfile);
}
